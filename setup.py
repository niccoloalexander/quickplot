...
setuptools.setup(
    name="quickplot-niccolo_hamlin", # Replace with your own username
    version="0.2.4",
    ...
    url="https://github.com/niccoloalexander/quickplot",
    project_urls={
        "Bug Tracker": "https://github.com/niccoloalexander/quickplot/issues",
    },
    classifiers=[
